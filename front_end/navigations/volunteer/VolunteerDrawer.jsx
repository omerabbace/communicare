...
// import FullReportModal from "../../screens/volunteer/FullReportModal";
...
//         }}
//       >
//         {(props) => <VolunteerHome {...props} fullName={fullName} isLeader= {isLeader}  />}
//       </Drawer.Screen>
...
function VolunteerDrawer({ navigation }) {
  ...
  return (
    <Drawer.Navigator
      ...
      screenOptions={{
        ...
        drawerLabelStyle: {
          marginLeft: -25,
          fontSize: 15,
          fontFamily: fontFamily, // Apply platform-specific font
        },
        drawerActiveBackgroundColor: "#aa18ea",
        drawerActiveTintColor: "#fff",
        drawerInactiveTintColor: "#333",
    ...
    >
      ...
      >
        {(props) => (
          <VolunteerHome {...props} fullName={fullName} isLeader={isLeader} />
        )}
      </Drawer.Screen>
      ...
      >
        {(props) => (
          <VolunteerManagementScreen {...props} isLeader={isLeader} />
        )}
      </Drawer.Screen>
